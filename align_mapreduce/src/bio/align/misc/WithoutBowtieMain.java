...
public class WithoutBowtieMain {
	...
	public static CommandLine parseInput( String args[] ) {
		...
		options.addOption( "bypass", true, "Bypass bowtie" );
	...
	public static Job getLocalJob( Configuration conf, CommandLine cmd, String localOutPath )
		...
		conf.setBoolean( "bypass", Boolean.parseBoolean( cmd.getOptionValue( "bypass" ) ) );
		...
		localJob.setJarByClass( WithoutBowtieMain.class );

		localJob.setMapperClass( WithoutAlignMapper.class );
		localJob.setReducerClass( WithoutAlignReducer.class );
	...
	public static Job getGlobalJob( Configuration conf, CommandLine cmd, String tempPath, String globalOutPath )
		...
		globalJob.setJarByClass( WithoutBowtieMain.class );

		globalJob.setMapperClass( WithoutCalcMapper.class );
		globalJob.setReducerClass( WithoutCalcReducer.class );
